...
// RUN: %cheri_purecap_clang -mcpu=cheri256 -mllvm -cheri-test-mode %S/Inputs/external_lib_user.c -c -o %t.o
// RUN: %cheri_purecap_clang -mcpu=cheri256 -mllvm -cheri-test-mode %S/Inputs/external_lib.c -c -o %t-externs.o
